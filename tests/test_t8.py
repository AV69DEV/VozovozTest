...
@pytest.mark.smoke
def test_order_submission_driver_data(driver):
    ...
    order_submission_page_object.click_driver_data_()
    ...
    order_submission_page_object.initialize_additional_fields()
    assert order_submission_page_object.driver_data_.get_attribute('content-desc') == f'Данные водителя\n{test_email}'
